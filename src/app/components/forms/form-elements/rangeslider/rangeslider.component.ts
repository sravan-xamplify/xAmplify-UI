...
import * as prismCodeData from '../../../../shared/data/prismData/forms/rangeslider'
...
@Component({
  ...
  standalone: true,
  imports: [SharedModule,FormsModule,ReactiveFormsModule,NouisliderModule,NgxSliderModule,ColorPickerModule,ShowcodeCardComponent],
