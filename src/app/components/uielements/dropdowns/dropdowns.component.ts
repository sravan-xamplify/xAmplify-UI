...
import * as PrismCode from '../../../shared/data/prismData/dropdowns';

import * as reuseCode from '../../../shared/data/prismData/dropdowns';
@Component({
...
export class DropdownsComponent {
  ...
  dropleft1 = [
    { Customclass: 'btn-group dropstart my-1 me-2', style: 'btn-primary dropdown-toggle', label: 'Dropleft', splitbutton: false, },
    { Customclass: 'btn-group my-1', style: 'btn-info dropdown-toggle dropdown-toggle-split ', buttonTag: true, splitbuttonEnd: true, splitbuttonClass: 'btn btn-info', splitTitle: 'Split dropstart' },
  ]
  alignmentOptions = [
