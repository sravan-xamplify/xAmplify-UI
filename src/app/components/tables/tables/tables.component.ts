...
import * as prismCodeData from '../../../shared/data/prismData/tables';
@Component({
  selector: 'app-tables',
  standalone: true,
...
export class TablesComponent {
  ...
  basicTables=[
    {name:"Mark",date:"21,Dec 2021",contact:"+1234-12340",bgColor:"primary",status:"Completed"},
    {name:"Monika",date:"29,April 2023",contact:"+1523-12459",bgColor:"warning",status:"Failed"},
    {name:"Madina",date:"30,Nov 2023",contact:"+1982-16234",bgColor:"success",status:"Successful"},
    {name:"Bhamako",date:"18,Mar 2023",contact:"+1526-10729",bgColor:"secondary",status:"Pending"},
 ]
 borderColumn=[
